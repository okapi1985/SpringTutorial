...
public class DesignAndOrderTacosBrowserTest {
    ...
    //
    //Method testing browser actions
    //
    ...
    private void submitEmptyOrderForm() {
        ...
        List<String> validationErrors = getValidationErrorsTexts();
    ...
    private List<String> getValidationErrorsTexts() {
    ...
    private void clickBulidAnotherTaco() {
        assertTrue(browser.getCurrentUrl().startsWith(orderDetailsPageUrl()));
        browser.findElementByCssSelector("a[id='another']").click();
    }

    //
    //Auxilliary methods of URL addreess
    //
